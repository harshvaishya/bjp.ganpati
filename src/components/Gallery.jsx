...
export default function Gallery() {
  ...
  return (
    <section className="px-6 py-16 bg-cream text-center">
      <p className="font-hindi text-sm tracking-wide text-gold-600 font-medium">झलकियाँ</p>
      <h2 className="font-display text-3xl text-cocoa-700 mt-2">तस्वीरों की झलक</h2>
