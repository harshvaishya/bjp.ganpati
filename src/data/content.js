...
export const location = {
  ...
  // If you have an exact Google Maps link, paste it here and the
  // location card will become tappable. Leave empty to keep it as
  // plain, readable text (see README.md for instructions).
  mapsUrl: '',
};
